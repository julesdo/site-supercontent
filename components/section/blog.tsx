        ...
        <div className="bg-gradient-to-b from-slate-950 to-indigo-950 py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    {posts.map((post) => (
                        <article key={post.id} className="flex flex-col transition-all p-4 bg-indigo-950 rounded-lg bg-background hover:border border-primary/80 hover:border-primary/100 transition-color shadow-[10px_10px_60px_10px] shadow-primary/0 hover:shadow-primary/60 items-start justify-between">
