...
export const frequencies = [
    { value: 'monthly', label: 'Monthly', priceSuffix: '/month/store' },
    { value: 'annually', label: 'Annually', priceSuffix: '/year/store' },
]
...
export const plans = [
    ...
    },
    {
        ...
        price: { monthly: 399, annually: 3830 },
        products: 'Unlimited',
        posts: 'Unlimited',
        basicSupport: false,
        active: true,
...
export default function Example() {
    ...
    return (
        <div id='pricing' className="bg-indigo-950 py-24 sm:py-32">
